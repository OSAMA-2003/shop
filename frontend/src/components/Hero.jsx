...
import heroImage from "../assets/herobg.jfif";
  ...
  return (
    ...
    >
      ...
      <div className='relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 flex flex-col justify-center'>
        ...
        >
          {/* Main Typography */}
          <h1 className='text-6xl sm:text-7xl md:text-8xl font-black uppercase leading-[0.95] tracking-tighter flex flex-col'>
            <span className="overflow-hidden block">
              <motion.span variants={textRevealVariants} className="text-white block">
                Redefine
              </motion.span>
            </span>
            <span className="overflow-hidden block mt-1 pb-2">
          ...
          <motion.div 
            ...
            className="border-l-[3px] border-[#ff5500] pl-5 mt-8"
          >
