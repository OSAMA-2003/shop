...
const MyOrders = () => {
  ...
  return (
    <section className='bg-linear-to-r from-indigo-900 via-pink-900 to-pink-900
        ...
        orders.length === 0 ? (
          ...
          <div className='grid gap-6 md:grid-cols-2 lg:grid-cols-3'>
            {orders.map((order) => {
              ...
              return (
                <div key={order._id} className='bg-linear-to-b from-purple-800 to-transparent
                  ...
                  <div>
                    ...
                    <div className='space-y-2'>
                      {order.items?.map((item) => (
                        <div key={item._id} className='flex justify-between items-center border-b border-gray-200
pb-2'>
          ...
          rounded '/>
                            ...
                            <p className='text-white'>{item.name}x{item.quantity || 1}
